...
#include "timer.h"
/*-------------------------Global Variables-------------------------*/
static volatile void(*g_Timer0_CallBack_ptr)(void)=NULL;
static volatile void(*g_Timer1_CallBack_ptr)(void)=NULL;
static volatile void(*g_Timer2_CallBack_ptr)(void)=NULL;
